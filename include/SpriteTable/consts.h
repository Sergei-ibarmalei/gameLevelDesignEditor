...
enum class ESpritesDirection { RIGHT = 1, LEFT = -1, };
...
constexpr float  BORDER_LEFTX{ (WINDOW_W / 2) -
                (BORDER_W / 2) };

constexpr float BORDER_LEFTY{ (WINDOW_H / 2) -
                (BORDER_H / 2) };
...
constexpr SDL_FRect BORDER{ BORDER_LEFTX,
    BORDER_LEFTY,
    BORDER_W,
    BORDER_H };
